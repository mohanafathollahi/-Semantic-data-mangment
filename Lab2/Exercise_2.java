...
public class Exercise_2 {
    ...
    private static class sendMsg extends AbstractFunction1<EdgeTriplet<Integer,Integer>,
        ...
        Tuple2<Object, Integer> destinationVertex = triplet.toTuple()._2();


        if (sourceVertex._2 != Integer.MAX_VALUE && sourceVertex._2 + triplet.attr() < destinationVertex._2){
	...
	public static void shortestPaths(JavaSparkContext ctx) {
        ...
        GraphOps ops = new GraphOps(G, scala.reflect.ClassTag$.MODULE$.apply(Integer.class),scala.reflect.ClassTag$.MODULE$.apply(Integer.class));  //ops?
